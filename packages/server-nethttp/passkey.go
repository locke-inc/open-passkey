// Package passkey provides a stdlib net/http WebAuthn server binding.
//
...
// registration and authentication ceremonies using only the standard library.
//
// Usage:
//
...
// Handler returns an http.Handler (http.ServeMux) with all passkey routes registered.
// Routes:
//
//	POST /register/begin
